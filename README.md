...
|                                  | Lost     |  Accuracy  | Learn Rate   | steps  |   GPU Usage  |   CPU Usage  |   System Memory  |
| :---:                            |  :----:  |    :---:   |  :----:  |    :---:   |    :----:    |    :----:    |    :----:        |
| Neural Net                       |  Title   |  Here's    |  Title   |  Here's    |    Here's    |    Here's    |    Here's        |
| Multi-Bidirectional LSTM         |  Text    | And more   |  Text    | And more   |    And more  |   And more   |   And more       |
| Stream LSTM                      |  Text    | And more   |  Text    | And more   |   And more   |   And more   |   And more       |
| Neual Net + Stream LSTM Concat   |  Text    | And more   |  Text    | And more   |   And more   |   And more   |   And more       |
