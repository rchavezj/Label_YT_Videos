...
![alt text](https://github.com/rchavezj/Label_YT_Videos/blob/master/wandb_results/pytorch_cpu.png){ width: 200px; }
![alt text](https://github.com/rchavezj/Label_YT_Videos/blob/master/wandb_results/pytorch_gpu.png){ width: 200px; }
